...
const InvitationDetailsDialog = ({
  open, onClose, invitation, onSetNotification, resetInvitation,
}) => {
  ...
  const invitationId = invitation && invitation.code.substring(0, invitation.code.indexOf('_'))
          ...
          <Box mb={2}>
            ...
            <Box className={classes.visitButtonContainer} mt={4} mb={2}>
              ...
              <Button
                ...
                onClick={() => resetInvitation(userData && userData.userId, invitationId)}
              >
                Reset Invitation
              </Button>
            </Box>
...
InvitationDetailsDialog.propTypes = {
  ...
  resetInvitation: PropTypes.func.isRequired,
}
